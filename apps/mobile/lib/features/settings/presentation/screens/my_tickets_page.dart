...
void _showTicketQrModal(BuildContext context, BookingHistoryItemDto ticket) {
  final theme = Theme.of(context);
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _TicketPoster(
                    posterUrl: ticket.fullPosterUrl,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${DateFormat('EEE, dd MMM yyyy • h:mm a').format(startsAt)} • ${ticket.seatCount} ${localeCopy(context, 'Seats', 'مقاعد')}',
                          style: theme.textTheme.bodySmall?.copyWith(
                  ...
                  _StatusPill(isPast: ticket.isPast),
                ],
              ),
              ...
              Container(
                ...
                child: QrImageView(
                  data: ticket.bookingReference.isNotEmpty
                      ? ticket.bookingReference
                      : 'TICKETA-${ticket.movieTitle}',
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      localeCopy(context, 'Booking Reference', 'رقم الحجز'),
                      style: TextStyle(
                ...
                children: [
                  ...
                  Text(
                    localeCopy(
                      ...
                      'أظهر رمز الـ QR عند بوابة السينما للدخول',
                    ),
                    style: theme.textTheme.bodySmall?.copyWith(
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  child: Text(
                    localeCopy(context, 'Close', 'إغلاق'),
                    style: TextStyle(
                      fontWeight: FontWeight.w900,
                      fontSize: 15,
                      color: theme.colorScheme.onSurface,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(22),
          onTap: () => _showTicketQrModal(context, ticket),
          child: Column(
            children: [
              Padding(
                padding: const EdgeInsets.all(16),
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              _InfoChip(
                                ...
                                localeCopy(context, 'QR Code', 'رمز QR'),
                                isHighlight: true,
                              ),
                            ],
                          ),
...
class _InfoChip extends StatelessWidget {
  ...
  const _InfoChip(this.icon, this.label, {this.isHighlight = false});
