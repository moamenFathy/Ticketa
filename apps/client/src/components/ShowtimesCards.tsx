  ...
  return (
    ...
    >
      <button className="w-full group cursor-pointer">
        <div className="flex items-center justify-between p-3 rounded-2xl bg-accent/50 group-hover:bg-primary transition-all duration-300 border border-white/5 group-hover:border-primary">
          <div className="flex items-center gap-3">
            <div className="bg-background group-hover:bg-white/20 p-2.5 rounded-xl transition-colors">
              <Clock className="w-4 h-4 text-primary group-hover:text-white" />
            </div>
            <div className="text-left">
              <p className="text-lg font-black group-hover:text-white">
